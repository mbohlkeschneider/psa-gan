    ...
    if missing_values == 0:
        if cold_start_value == 0:
            di = {
                ...
                "exchange_rate": 8,
                "traffic": 862,
                "s3://YOUR-BUCKET/datasets/solar_nips_scaled/": 137,
                "s3://YOUR-BUCKET/datasets/traffic_nips_scaled/": 963,
                "s3://YOUR-BUCKET/datasets/m4_hourly_scaled/": 414,
                "s3://YOUR-BUCKET/datasets/exchange_rate_nips_scaled/": 8,
                "s3://YOUR-BUCKET/datasets/electricity_nips_scaled/": 370,
            }
            return di
        else:
            di_COLD = {
                ...
                "exchange_rate": 8,
                "traffic": 862,
                f"s3://YOUR-BUCKET/datasets_cold/solar_nips_cold_{cold_start_value}/": 137,
                f"s3://YOUR-BUCKET/datasets_cold/traffic_nips_cold_{cold_start_value}/": 963,
                f"s3://YOUR-BUCKET/datasets_cold/m4_hourly_cold_{cold_start_value}/": 414,
                f"s3://YOUR-BUCKET/datasets_cold/exchange_rate_nips_cold_{cold_start_value}/": 8,
                f"s3://YOUR-BUCKET/datasets_cold/electricity_nips_cold_{cold_start_value}/": 370,
            }
            return di_COLD
    else:
        di = {
            f"s3://YOUR-BUCKET/mv-datasets2/solar_nips_scaled-stretch-len-{missing_values}/": 137,
            f"s3://YOUR-BUCKET/mv-datasets2/traffic_nips_scaled-stretch-len-{missing_values}/": 963,
            f"s3://YOUR-BUCKET/mv-datasets2/m4_hourly_scaled-stretch-len-{missing_values}/": 414,
            f"s3://YOUR-BUCKET/mv-datasets2/exchange_rate_nips_scaled-stretch-len-{missing_values}/": 8,
            f"s3://YOUR-BUCKET/mv-datasets2/electricity_nips_scaled-stretch-len-{missing_values}/": 370,
        }
        return di
    ...
    if missing_values == 0:
        if cold_start_value == 0:
            di = {
                ...
                "exchange_rate": [3],
                "traffic": [4],
                "s3://YOUR-BUCKET/datasets/solar_nips_scaled/": [
                    4
                ],
                "s3://YOUR-BUCKET/datasets/traffic_nips_scaled/": [
                    4
                ],
                "s3://YOUR-BUCKET/datasets/m4_hourly_scaled/": [
                    4
                ],
                "s3://YOUR-BUCKET/datasets/exchange_rate_nips_scaled/": [
                    3
                ],
                "s3://YOUR-BUCKET/datasets/electricity_nips_scaled/": [
                    4
                ],
            }
            return di
            ...
            di_COLD = {
                ...
                "exchange_rate": [3],
                "traffic": [4],
                f"s3://YOUR-BUCKET/datasets_cold/solar_nips_cold_{cold_start_value}/": [
                    4
                ],
                f"s3://YOUR-BUCKET/datasets_cold/traffic_nips_cold_{cold_start_value}/": [
                    4
                ],
                f"s3://YOUR-BUCKET/datasets_cold/m4_hourly_cold_{cold_start_value}/": [
                    4
                ],
                f"s3://YOUR-BUCKET/datasets_cold/exchange_rate_nips_cold_{cold_start_value}/": [
                    3
                ],
                f"s3://YOUR-BUCKET/datasets_cold/electricity_nips_cold_{cold_start_value}/": [
                    4
                ],
            }
            return di_COLD
        ...
        di = {
            f"s3://YOUR-BUCKET/mv-datasets2/solar_nips_scaled-stretch-len-{missing_values}/": [
                4
            ],
            f"s3://YOUR-BUCKET/mv-datasets2/traffic_nips_scaled-stretch-len-{missing_values}/": [
                4
            ],
            f"s3://YOUR-BUCKET/mv-datasets2/m4_hourly_scaled-stretch-len-{missing_values}/": [
                4
            ],
            f"s3://YOUR-BUCKET/mv-datasets2/exchange_rate_nips_scaled-stretch-len-{missing_values}/": [
                3
            ],
            f"s3://YOUR-BUCKET/mv-datasets2/electricity_nips_scaled-stretch-len-{missing_values}/": [
                4
            ],
        }
        return di
    ...
    if missing_value == 0:
        if cold_start_value == 0:
            ...
            DS_COLD = [
                ...
                f"s3://YOUR-BUCKET/datasets_cold/m4_hourly_cold_{cold_start_value}/",
                f"s3://YOUR-BUCKET/datasets_cold/solar_nips_cold_{cold_start_value}/",
                # "s3://YOUR-BUCKET/datasets_cold/exchange_rate_nips_cold_{cold_start_value}/",
                f"s3://YOUR-BUCKET/datasets_cold/electricity_nips_cold_{cold_start_value}/",
            ]
            return DS_COLD
    else:
        DS_MV = [
            f"s3://YOUR-BUCKET/mv-datasets2/traffic_nips_scaled-stretch-len-{missing_value}/",
            f"s3://YOUR-BUCKET/mv-datasets2/m4_hourly_scaled-stretch-len-{missing_value}/",
            f"s3://YOUR-BUCKET/mv-datasets2/solar_nips_scaled-stretch-len-{missing_value}/",
            # "s3://YOUR-BUCKET/mv-datasets2/exchange_rate_nips_scaled-stretch-len-{missing_value}/",
            f"s3://YOUR-BUCKET/mv-datasets2/electricity_nips_scaled-stretch-len-{missing_value}/",
        ]
        return DS_MV
